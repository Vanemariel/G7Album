    ...
    public partial class inicio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000, 1000, 1, 1, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5044), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5053), "Copa Libertadores" },
                    { 2, 1000, 1000, 2, 1, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5061), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5062), "Champions Lague" },
                    { 3, 1000, 1000, 3, 1, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5064), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5064), "Copa America" },
                    { 4, 1000, 1000, 4, 2, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5066), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5066), "Winledom" },
                    { 5, 1000, 1000, 5, 2, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5068), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5068), "Rollan Garros" },
                    { 6, 1000, 1000, 6, 2, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5070), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5071), "Us Open" },
                    { 7, 1000, 1000, 7, 3, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5072), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5073), "Liga ndesa" },
                    { 8, 1000, 1000, 8, 3, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5074), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5075), "NBA" },
                    { 9, 1000, 1000, 9, 3, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5076), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5077), "La Liga Argentina" },
                    { 10, 1000, 1000, 10, 4, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5078), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5079), "National Rugby League" },
                    { 11, 1000, 1000, 11, 4, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5081), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5081), "Super League" },
                    { 12, 1000, 1000, 12, 4, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5083), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5083), "The Rugby Championship" },
                    { 13, 1000, 1000, 1, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5085), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5085), "Dragonball" },
                    { 14, 1000, 1000, 2, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5087), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5088), "Dragonball Z" },
                    { 15, 1000, 1000, 3, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5122), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5123), "Dragonball Super" },
                    { 16, 1000, 1000, 4, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5125), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5125), "Naruto" },
                    { 17, 1000, 1000, 5, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5127), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5127), "Naruto Shippuden" },
                    { 18, 1000, 1000, 6, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5129), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5129), "Naruto Next Generation" },
                    { 19, 1000, 1000, 7, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5131), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5132), "Saint Seiya the Lost Canvas" },
                    { 20, 1000, 1000, 8, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5133), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5134), "Batalla de Poseidon" },
                    { 21, 1000, 1000, 9, 5, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5135), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5136), "Batalla de Asgard" },
                    { 22, 1000, 1000, 100, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5137), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5138), "Monster Inc" },
                    { 23, 1000, 1000, 101, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5139), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5140), "Monster University" },
                    { 24, 1000, 1000, 102, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5142), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5142), "High school Musical" },
                    { 25, 1000, 1000, 104, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5144), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5144), "High school Musical 2" },
                    { 26, 1000, 1000, 105, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5146), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5147), "La era del hielo 1" },
                    { 27, 1000, 1000, 106, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5148), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5149), "La era del hielo 2" },
                    { 28, 1000, 1000, 107, 6, "figus", new DateTime(2022, 10, 15, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5150), new DateTime(2022, 10, 25, 13, 17, 12, 684, DateTimeKind.Local).AddTicks(5151), "La era del hielo 3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7, 1, 1000, 37, " ", 20, "Bou Walter" },
                    { 8, 1, 1000, 38, " ", 21, "Pratto Lucas" },
                    { 9, 1, 1000, 39, " ", 22, "Franco Daniel" },
                    { 10, 1, 1000, 40, " ", 23, "ArmanI Franco" },
                    { 11, 1, 1000, 41, " ", 24, "Guido Herrera" },
                    { 12, 1, 1000, 42, " ", 25, "Salas" },
                    { 13, 1, 1000, 43, "si", 26, "Firmiño" },
                    { 14, 1, 1000, 44, " ", 27, "Alvarez Julian" },
                    { 15, 1, 1000, 45, " ", 28, "Halan" },
                    { 16, 1, 1000, 46, " ", 29, "Cuti Romero" },
                    { 17, 1, 1000, 47, " ", 30, "Dibu Martinez" },
                    { 18, 2, 1000, 48, " ", 31, "Nadal Rafael" },
                    { 19, 2, 1000, 49, " ", 32, "Federer Roger" },
                    { 20, 2, 1000, 50, " ", 33, "Murray" },
                    { 21, 2, 1000, 51, " ", 34, "Del Potro" },
                    { 22, 2, 1000, 52, " ", 35, "David Nalvandian" },
                    { 23, 2, 1000, 53, " ", 36, "Novak Djovich" },
                    { 24, 2, 1000, 54, "", 37, "Nadal Rafael" },
                    { 25, 2, 1000, 55, " ", 37, "Federer Roger" },
                    { 26, 2, 1000, 56, " ", 38, "Murray" },
                    { 27, 2, 1000, 57, " ", 39, "Del Potro" },
                    { 28, 2, 1000, 58, " ", 40, "David Nalvandian" },
                    { 29, 2, 1000, 60, " ", 42, "Nadal Rafael" },
                    { 30, 2, 1000, 61, " ", 43, "Federer Roger" },
                    { 31, 2, 1000, 62, " ", 44, "Murray" },
                    { 32, 2, 1000, 63, " ", 45, "Del Potro" },
                    { 33, 2, 1000, 64, " ", 46, "David Nalvandian" },
                    { 34, 2, 1000, 65, " ", 47, "Novak Djokovich" },
                    { 35, 2, 1000, 66, " ", 48, "Nadal Rafael" },
                    { 36, 2, 1000, 67, " ", 49, "Federer Roger" },
                    { 37, 2, 1000, 68, " ", 50, "Murray" },
                    { 38, 2, 1000, 69, " ", 51, "Del Potro" },
                    { 39, 2, 1000, 70, " ", 52, "David Nalvandian" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 40, 2, 1000, 71, " ", 53, "Novak Djokovich" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2800, 2, 1000, 59, " ", 41, "Novak Djokovich" }
                });
