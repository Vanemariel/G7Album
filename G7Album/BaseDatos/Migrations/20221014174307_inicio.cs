    ...
    public partial class inicio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000, 1000, 1, 1, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8922), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8934), "Copa Libertadores" },
                    { 2, 1000, 1000, 2, 1, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8940), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8940), "Champions Lague" },
                    { 3, 1000, 1000, 3, 1, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8941), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8942), "Copa America" },
                    { 4, 1000, 1000, 4, 2, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8943), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8943), "Winledom" },
                    { 5, 1000, 1000, 5, 2, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8947), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8947), "Rollan Garros" },
                    { 6, 1000, 1000, 6, 2, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8948), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8948), "Us Open" },
                    { 7, 1000, 1000, 7, 3, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8949), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8949), "Liga ndesa" },
                    { 8, 1000, 1000, 8, 3, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8953), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8953), "NBA" },
                    { 9, 1000, 1000, 9, 3, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8955), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8955), "La Liga Argentina" },
                    { 10, 1000, 1000, 10, 4, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8956), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8957), "National Rugby League" },
                    { 11, 1000, 1000, 11, 4, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8957), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8958), "Super League" },
                    { 12, 1000, 1000, 12, 4, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8959), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8959), "The Rugby Championship" },
                    { 13, 1000, 1000, 1, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8960), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8960), "Dragonball" },
                    { 14, 1000, 1000, 2, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8961), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8961), "Dragonball Z" },
                    { 15, 1000, 1000, 3, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8962), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8963), "Dragonball Super" },
                    { 16, 1000, 1000, 4, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8963), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8964), "Naruto" },
                    { 17, 1000, 1000, 5, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8965), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8965), "Naruto Shippuden" },
                    { 18, 1000, 1000, 6, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8966), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8966), "Naruto Next Generation" },
                    { 19, 1000, 1000, 7, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8967), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8967), "Saint Seiya the Lost Canvas" },
                    { 20, 1000, 1000, 8, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8968), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8968), "Batalla de Poseidon" },
                    { 21, 1000, 1000, 9, 5, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8969), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8969), "Batalla de Asgard" },
                    { 22, 1000, 1000, 100, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8970), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8971), "Monster Inc" },
                    { 23, 1000, 1000, 101, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8972), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8972), "Monster University" },
                    { 24, 1000, 1000, 102, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8973), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8973), "High school Musical" },
                    { 25, 1000, 1000, 104, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8974), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8974), "High school Musical 2" },
                    { 26, 1000, 1000, 105, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8975), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8976), "La era del hielo 1" },
                    { 27, 1000, 1000, 106, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8976), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8977), "La era del hielo 2" },
                    { 28, 1000, 1000, 107, 6, "figus", new DateTime(2022, 10, 14, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8978), new DateTime(2022, 10, 24, 14, 43, 6, 867, DateTimeKind.Local).AddTicks(8979), "La era del hielo 3" }
                });
