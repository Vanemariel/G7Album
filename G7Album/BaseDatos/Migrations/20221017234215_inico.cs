    ...
    public partial class inico : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 127, 69, 1000, 169, " ", 151, "Naruto" },
                    { 128, 69, 1000, 170, " ", 152, "Sasuke" },
                    { 129, 69, 1000, 171, " ", 153, "Itachi" },
                    { 130, 69, 1000, 172, " ", 154, "Sakura" },
                    { 131, 69, 1000, 173, " ", 155, "Madara" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1000, 1000, 1, 1, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5337), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5345), "Copa Libertadores" },
                    { 2, 1000, 1000, 2, 1, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5351), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5351), "Champions Lague" },
                    { 3, 1000, 1000, 3, 1, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5353), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5353), "Copa America" },
                    { 4, 1000, 1000, 4, 2, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5354), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5355), "Winledom" },
                    { 5, 1000, 1000, 5, 2, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5356), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5356), "Rollan Garros" },
                    { 6, 1000, 1000, 6, 2, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5358), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5358), "Us Open" },
                    { 7, 1000, 1000, 7, 3, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5359), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5360), "Liga Endesa" },
                    { 8, 1000, 1000, 8, 3, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5361), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5362), "NBA" },
                    { 9, 1000, 1000, 9, 3, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5363), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5363), "La Liga Argentina" },
                    { 10, 1000, 1000, 10, 4, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5365), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5365), "National Rugby League" },
                    { 11, 1000, 1000, 11, 4, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5366), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5367), "Super League" },
                    { 12, 1000, 1000, 12, 4, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5368), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5368), "The Rugby Championship" },
                    { 13, 1000, 1000, 100, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5370), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5370), "Monster Inc" },
                    { 14, 1000, 1000, 101, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5397), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5398), "Monster University" },
                    { 15, 1000, 1000, 102, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5399), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5399), "High school Musical" },
                    { 16, 1000, 1000, 104, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5401), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5401), "High school Musical 2" },
                    { 26, 1000, 1000, 105, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5402), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5403), "La era del hielo 1" },
                    { 27, 1000, 1000, 106, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5404), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5405), "La era del hielo 2" },
                    { 28, 1000, 1000, 107, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5406), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5406), "La era del hielo 3" },
                    { 63, 1000, 1000, 1, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5411), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5412), "Dragonball" },
                    { 64, 1000, 1000, 2, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5413), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5413), "Dragonball Z" },
                    { 65, 1000, 1000, 3, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5415), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5415), "Dragonball Super" },
                    { 70, 1000, 1000, 5, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5418), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5419), "Naruto Shippuden" },
                    { 71, 1000, 1000, 6, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5420), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5420), "Naruto Next Generation" },
                    { 80, 1000, 1000, 7, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5422), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5422), "Saint Seiya the Lost Canvas" },
                    { 81, 1000, 1000, 8, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5423), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5424), "Batalla de Poseidon" },
                    { 82, 1000, 1000, 9, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5425), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5426), "Batalla de Asgard" },
                    { 96, 1000, 1000, 4, 6, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5417), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5417), "Naruto" },
                    { 100, 1000, 1000, 107, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5408), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5408), "Avatar" },
                    { 101, 1000, 1000, 107, 5, "figus", new DateTime(2022, 10, 17, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5410), new DateTime(2022, 10, 27, 20, 42, 15, 350, DateTimeKind.Local).AddTicks(5410), "Avatar 2" }
                });
            ...
            migrationBuilder.InsertData(
                table: "TablaImagenes",
                columns: new[] { "Id", "AlbumId", "CantidadImpresa", "CodigoImagenOriginal", "Imagen", "NumeroImagen", "Titulo" },
                values: new object[] { 1180, 64, 1000, 160, " ", 142, "Vegeta" });

            migrationBuilder.InsertData(
                table: "TablaImagenes",
                columns: new[] { "Id", "AlbumId", "CantidadImpresa", "CodigoImagenOriginal", "Imagen", "NumeroImagen", "Titulo" },
                values: new object[] { 2800, 5, 1000, 59, " ", 41, "Novak Djokovich" });
